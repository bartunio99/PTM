...
// program glówny
	...
	key_1:	LCDcntrlWR #HOME
			...
			mov r4, a	; przechowanie cyfry do dodania
			; przechowanie wskaznika stosu
			mov r5, dpl
			mov r6, dph
			...
			; przywrocenie poprzedniego wskaznika stosu
			mov dpl, r5
			mov dph, r6
	...
	adding:	add a, r4	; dodac pierwsza liczbe do drugiej
			mov P1, a
			acall putcharLCD
			acall delay
			LCDcntrlWR #CLEAR
